...
const config = {
    title: 'Eloquent DDD',
    tagline: 'Develop Laravel project with a Domain Driven Architecture',
        ...
        [
            ...
            ({
                docs: {
                    ...
                    editUrl:
                        'https://github.com/bricknpc/eloquent-ddd/tree/main/docs/',
                },
                blog: {
        ...
        ({
            ...
            navbar: {
                ...
                items: [
                    ...
                    {
                        href: 'https://github.com/bricknpc/eloquent-ddd',
                        label: 'GitHub',
                        position: 'right',
                    },
                ],
